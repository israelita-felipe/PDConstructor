...
public class CustomDrawerLayout extends DrawerLayout {
    ...
    private SimpleIntegerProperty responsiveWidth = new SimpleIntegerProperty(
	    (int) Toolkit.getDefaultToolkit().getScreenSize().getWidth() + 8);
	...
	if (drawerOpened) {
	    ...
	    animation = new Timeline(
		    new KeyFrame(DEFAULT_TIME_ANIM, new KeyValue(nav.translateXProperty(), 0, Interpolator.EASE_OUT),
	...
	responsiveWidth.setValue(forceNarrow ? 0 : Toolkit.getDefaultToolkit().getScreenSize().getWidth() + 8);
    }
