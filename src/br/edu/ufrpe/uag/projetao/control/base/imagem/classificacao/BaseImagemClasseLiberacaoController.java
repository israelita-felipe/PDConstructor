...
public class BaseImagemClasseLiberacaoController extends Fragment {
    ...
    private void list() {
	getChildren().clear();
	this.loader.setLocation(getClass().getResource("BaseImagemClasseLiberacaoView.fxml"));
	try {
	    this.loader.load();
	...
	if (liberacao != null) {
	    ...
	    this.loader.setLocation(getClass().getResource("BaseImagemClasseClassificacaoView.fxml"));
