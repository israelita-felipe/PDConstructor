...
public class BaseImagemClasseListController extends Fragment {
    ...
    private void novo() {
	getChildren().clear();
	this.loader.setLocation(getClass().getResource("BaseImagemClasseCriarView.fxml"));
	try {
	    this.loader.load();
	} catch (IOException e) {
    ...
    private void list() {
	getChildren().clear();
	this.loader.setLocation(getClass().getResource("BaseImagemClasseListView.fxml"));
	try {
	    this.loader.load();
	...
	if (basesImagemClasse.getSelectionModel().getSelectedItem() != null) {
	    ...
	    getChildren().clear();
	    this.loader.setLocation(getClass().getResource("BaseImagemClasseLiberaUsuarioView.fxml"));
	    try {
		this.loader.load();
