...
public class BaseImagemDeteccaoListController extends Fragment {
    ...
    private void novo() {
	getChildren().clear();
	this.loader.setLocation(getClass().getResource("BaseImagemDeteccaoCriarView.fxml"));
	try {
	    this.loader.load();
	} catch (IOException e) {
	...
	try {
	    ...
	    InterfaceDBController<BaseImagemDeteccao> base = ControllerFactory.getBaseImagemDeteccaoController();

	    InterfaceDBController<AlocacaoImagemDeteccao> alocacaoImagemDeteccao = ControllerFactory
		    .getAlocacaoImagemDeteccaoController();
	    InterfaceDBController<ImagemDeteccao> imagemDeteccaoController = ControllerFactory
    ...
    private void list() {
	getChildren().clear();
	this.loader.setLocation(getClass().getResource("BaseImagemDeteccaoListView.fxml"));
	try {
	    this.loader.load();
	...
	if (this.tabelaEscravos.getSelectionModel().getSelectedItem() != null) {
	    InterfaceDBController<LiberacaoBaseImagemDeteccao> liberacoesController = ControllerFactory
	...
	if (basesImagemDeteccao.getSelectionModel().getSelectedItem() != null) {
	    ...
	    getChildren().clear();
	    this.loader.setLocation(getClass().getResource("BaseImagemDeteccaoLiberaUsuarioView.fxml"));
	    try {
		this.loader.load();
