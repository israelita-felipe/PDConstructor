...
-- object: public.RESPOSTA_TEXTO | type: TABLE --
-- DROP TABLE IF EXISTS public.RESPOSTA_TEXTO CASCADE;
CREATE TABLE RESPOSTA_TEXTO(
	ALOCACAO_CLASSE_TEXTO integer NOT NULL,
	ESCOLHA_CLASSE_TEXTO integer NOT NULL,
	CONSTRAINT RESPOSTA_TEXTO_PK PRIMARY KEY(ALOCACAO_CLASSE_TEXTO,ESCOLHA_CLASSE_TEXTO),
	CONSTRAINT RESPOSTA_TEXTO_ESCOLHA_TEXTO_FK FOREIGN KEY(ESCOLHA_CLASSE_TEXTO) REFERENCES ESCOLHA_CLASSE_TEXTO(ID) ON DELETE RESTRICT,
	CONSTRAINT RESPOSTA_TEXTO_ALOCACAO_TEXTO_FK FOREIGN KEY (ALOCACAO_CLASSE_TEXTO) REFERENCES ALOCACAO_TEXTO(ID) ON DELETE RESTRICT
);
