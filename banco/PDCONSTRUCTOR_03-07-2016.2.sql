...
-- object: base_texto_histograma | type: VIEW --
DROP VIEW IF EXISTS base_texto_histograma CASCADE;
CREATE VIEW base_texto_histograma
AS 
...
FROM
   escolha_classe_texto,
	base_texto,
	alocacao_texto
WHERE
   escolha_classe_texto.alocacao_texto = alocacao_texto.id
	AND
	alocacao_texto.base_texto = base_texto.id
ORDER BY 
	base_texto.id;
-- ddl-end --
ALTER VIEW base_texto_histograma OWNER TO postgres;
-- ddl-end --

-- object: base_imagem_classe_histograma | type: VIEW --
DROP VIEW IF EXISTS base_imagem_classe_histograma CASCADE;
CREATE VIEW base_imagem_classe_histograma
AS 
...
SELECT
   distinct
	...
	(select count(*)
		FROM 
		  classsificacao_imagem_classe, 
		  base_imagem_classe, 
		  alocacao_imagem_classe
		WHERE 
...
FROM
   escolha_imagem_classe,
	base_imagem_classe,
	alocacao_imagem_classe
WHERE
   escolha_imagem_classe.alocacao_imagem_classe = alocacao_imagem_classe.id
	AND
	alocacao_imagem_classe.base_imagem_classe = base_imagem_classe.id
ORDER BY 
	base_imagem_classe.id;
-- ddl-end --
ALTER VIEW base_imagem_classe_histograma OWNER TO postgres;
-- ddl-end --

-- object: base_imagem_deteccao_histograma | type: VIEW --
DROP VIEW IF EXISTS base_imagem_deteccao_histograma CASCADE;
CREATE VIEW base_imagem_deteccao_histograma
AS 

SELECT
   distinct imagem_deteccao.id,imagem_deteccao.objeto,base_imagem_deteccao.id as base,
(select count(*)
...
WHERE
   alocacao_imagem_deteccao.base_imagem_deteccao = base_imagem_deteccao.id AND	
	imagem_deteccao.id = alocacao_imagem_deteccao.imagem_deteccao 
order by
	base_imagem_deteccao.id;
-- ddl-end --
ALTER VIEW base_imagem_deteccao_histograma OWNER TO postgres;
-- ddl-end --
...
insert into PERFIL(NOME,DESCRICAO) values('SUPERVISOR','SUPERVISOR');
insert into PERFIL(NOME,DESCRICAO) values('CLASSIFICADOR','CLASSIFICADOR')